...
<div class=" p-10 rounded max-w-4xl mx-auto mt-20">
                    ...
                    <form method="POST" action="/admin/products/{{$product->id}}" enctype="multipart/form-data" class="text-gray-600">
                        @csrf
                        @method('put')
                        <div class="flex">
                        ...
                        <div class="mb-3 mx-6 w-full">
                            ...
                            <option value="{{$product->category}}" class="text-gray-600">{{$product->category}}</option>
                        ...
                        <div class="mb-3 mx-6 w-full">
                            <label
                                for="price"
                                class="inline-block text-sm tracking-wide mb-0"
                            >
                            Buying price
                            </label>
                            <input
                        ...
                        <div class="mb-6 mx-6 w-full">
                                <label
                                    for="description"
                                    class="inline-block text-sm tracking-wide mb-0 text-gray-500"
                                >
                                  Description  
                                </label>
                                <textarea
                        ...
                        <div class="mb-6 mx-6 w-full">
                            ...
                            <div class="w-2/5 mr-2">
                                <label
                                    ...
                                    class="inline-block text-sm mb-0 tracking-wide"
                                >
                                    Stock
                                </label>
                                <input
                            ...
                            <div class="w-3/5">
                                ...
                                <label for="added_to_stock" class="inline-block text-sm mb-1 tracking-wide">Quantity Added</label
                                >
                                <input
                                    id="added-stock"
                                    type="number"
...
<script>
    const productManagament = document.getElementById('product-managament');
        ...
        productManagament.classList.add('text-laravel');
